...
public class PV2PageApp {
    public static void main(String[] args) throws Exception{
        ...
        job.setJarByClass(PV2PageApp.class);

        job.setMapperClass(PV2PageApp.PV2PageMapper.class);
        job.setReducerClass(PV2PageApp.PV2PageReducer.class);
        ...
        job.setCombinerClass(PV2PageApp.PV2PageReducer.class);

/*
        String input = "E:\\ImprovementWorkingSpace\\hadoop-learning\\src\\main\\resources\\logdata\\ETLData\\*.log";
        String output = "E:\\ImprovementWorkingSpace\\hadoop-learning\\src\\main\\resources\\logdata\\PV2PageOut";
*/
    ...
    static class PV2PageMapper extends Mapper<LongWritable, Text, Text, LongWritable> {
    ...
    static class PV2PageReducer extends Reducer<Text, LongWritable, Text, LongWritable> {
